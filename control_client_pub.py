...
client.publish("franka_grasp",payload="gripper_speed=[0.02]|gripper_forced=[20.0]|clamp=[1]",qos=0)
...
client.publish('franka_joint_motion',payload='jointmotion=[0.1, -0.785398163397448279, 0.0, -2.356194490192344837, 0.0, 1.570796326794896558, 0.785398163397448279]\
