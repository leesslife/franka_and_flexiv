    ...
    def run(self):
        ...
        while len(self.taskqueque)!=0:
            ...
            if self.taskqueque[0].topic=='franka_joint_motion':
                ...
                if indexRel==-1:
                    self.dynamic_rel=[0.15]
                    print("cant find dynamic_rel,use the rel=0.15")
                ...
                if indexRel!=-1:
                    ...
                    for i in range(indexRel,len(payloadstring)):
                        ...
                        if payloadstring[i]=="]":
                            ...
                            if fb_flag[0]>=fb_flag[1]:
                                self.dynamic_rel=[0.15]
                                print("set default dynamic_rel!")
                                indexRel=-2
                            break
                        if (i==len(payloadstring)-1) and (payloadstring[i]!="]"):
                            self.dynamic_rel=[0.15]
                            print("no default Value can be found,set default dynamic_rel!")
                            indexRel=-2
                            break
                    ...
                    if indexRel!=-2:
                        motionString=payloadstring[fb_flag[0]+1:fb_flag[1]].replace(" ","")
                        motionString=''.join([i for i in motionString if not i.isalpha()])
                        self.dynamic_rel=list(map(float,motionString.split(',')))
                    
                    if len(self.dynamic_rel)!=1:
                ...
                if len(Value)==7:
                    #print("Value:::",Value)
                    #print("dy_rel:::",self.dynamic_rel[0])
                    self.robot.set_dynamic_rel(self.dynamic_rel[0])
                ...
                # today is over 
                print(len(graspsetlist))
                for i in range(len(graspsetlist)):
                    print(graspsetlist[i])
                    ...
                    #    self.taskqueque.pop(0)
                    #    return
                print(graspMap["gripper_speed"])
                print(graspMap["gripper_forced"])
